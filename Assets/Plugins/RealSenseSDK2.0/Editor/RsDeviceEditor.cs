    ...
    public override void OnInspectorGUI()
    {
        ...
        switch ((RsConfiguration.Mode)mode.enumValueIndex)
        {
            case RsConfiguration.Mode.Live:
                ...
                EditorGUILayout.PropertyField(config.FindPropertyRelative("LocalizationMapName"));

                EditorGUILayout.Space();
                EditorGUILayout.PropertyField(config.FindPropertyRelative("EnableMapping"));
                EditorGUILayout.PropertyField(config.FindPropertyRelative("EnablePoseJumping"));
                EditorGUILayout.PropertyField(config.FindPropertyRelative("EnableRelocalization"));
                EditorGUILayout.PropertyField(config.FindPropertyRelative("EnableDynamicCalibration"));
